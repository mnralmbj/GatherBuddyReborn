...
namespace GatherBuddy.AutoGatherV2.StateMachine
{
    public abstract class StateMachine
    {
        ...
        private Dictionary<Triggers, StateMachine> transitions = new Dictionary<Triggers, StateMachine>();
        ...
        {
            //GatherBuddy.Log.Information("Update from :" + this.GetType().Name);
            TaskManager.Step();
        }
        ...
        public void AddTransition(StateMachine from, StateMachine to, Triggers trigger)
        {
        ...
        public void SendTrigger(Triggers trigger)
        {
            var root = this;
